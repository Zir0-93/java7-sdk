    ...
    static URLStreamHandler getURLStreamHandler(String protocol) {
        ...
        if (handler == null) {
                ...
                while (handler == null &&
                    ...
                    try {
                        ...
                        try {
                            ...
                            ClassLoader cl = com.ibm.jvm.ClassLoader.getLastClassLoader();//JSE-4059  //IBM-java_signal_dispatcher
                            if (cl != null) {
            ...
            synchronized (streamHandlerLock) {
                ...
                if (handler != null)                                            //IBM-T6_wrt_bringup
                {                                                               //IBM-T6_wrt_bringup
                    //handlers.put(protocol, handler);                          //IBM-T6_wrt_bringup
