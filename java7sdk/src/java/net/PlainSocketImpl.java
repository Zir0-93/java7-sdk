...
import sun.security.action.GetPropertyAction;                                   //IBM-T6_net_fixes
...
class PlainSocketImpl extends AbstractPlainSocketImpl
{
    ...
    static {
        /*java.security.AccessController.doPrivileged( new PrivilegedAction<Object>() { //IBM-T6_net_fixes
                public Object run() {
                    version = 0;
                    try {
        ...
        /* JSE-7166 */                                                          //IBM-T6_net_fixes
    	version = Float.parseFloat(java.security.AccessController.doPrivileged //IBM-T6_net_fixes
    	                       (new GetPropertyAction("os.version")));      //IBM-T6_net_fixes
    	preferIPv4Stack = Boolean.parseBoolean(java.security.AccessController.doPrivileged //IBM-T6_net_fixes
                (new GetPropertyAction("java.net.preferIPv4Stack")));           //IBM-T6_net_fixes
    	/* JSE-7166 end */                                                  //IBM-T6_net_fixes
	                                                                        //IBM-T6_net_fixes
    ...
    void processNRException(InetAddress address, int port, int backlogQ)        //IBM-zos_cinet
        throws IOException {                                                                   /*JSE-2495*/ //IBM-zos_cinet
        /* Doing nothing as this method is only used on z/OS CINET env          //IBM-zos_cinet
         * the program control should never come here                           //IBM-zos_cinet
         */                                                                     //IBM-zos_cinet
    }                                                                           //IBM-zos_cinet
                                                                                //IBM-zos_cinet
