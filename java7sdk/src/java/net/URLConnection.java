...
public abstract class URLConnection {
    ...
    */
    ...
    public static synchronized FileNameMap getFileNameMap() {
        if ((fileNameMap == null) && !fileNameMapLoaded)                        //IBM-T6_wrt_bringup
        {                                                                       //IBM-T6_wrt_bringup
            //fileNameMap = sun.net.www.MimeTable.loadTable();                  //IBM-T6_wrt_bringup
			...
			fileNameMapLoaded = true;                               //IBM-T6_wrt_bringup
        }
   ...
   /**
    ...
    throws UnknownServiceException
    {
        ...
        if (handler == null) {
            ...
            //handlers.put(contentType, handler);                               //IBM-T6_wrt_bringup
