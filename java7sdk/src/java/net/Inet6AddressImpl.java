...
class Inet6AddressImpl implements InetAddressImpl {
    ...
    public synchronized InetAddress anyLocalAddress() {
        if (anyLocalAddress == null) {
               if (InetAddress.preferIPv6Address)                                  //IBM-T6_wrt_bringup
            {                                                                   //IBM-T6_wrt_bringup
                //anyLocalAddress = new Inet6Address();                         //IBM-T6_wrt_bringup
                //anyLocalAddress.holder().hostName = "::";                              //IBM-T6_wrt_bringup
