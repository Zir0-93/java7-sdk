...
public abstract class URLStreamHandler {
    ...
    protected void parseURL(URL u, String spec, int start, int limit) {
        ...
        /* JSE - 3056                                                           //IBM-net_bringup
         * If the hierarchical components of the path are separated by a        //IBM-net_bringup
         * Windows separator '\' then, replace it by valid URL separator '/'.   //IBM-net_bringup
         */                                                                     //IBM-net_bringup
        if(null!=path && path.indexOf('/') == -1)                               //IBM-net_bringup
            path = path.replace(File.separatorChar, '/');                       //IBM-net_bringup
