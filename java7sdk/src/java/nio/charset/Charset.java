    ...
    implements Comparable<Charset>
{
    ...
    /* Flag to indicate file.encoding="bestfit936" is in effect */              
    private static boolean useMS936AForGBK = false;                             
                                                                                
    static {                                                                    
        String encoding = ((String)AccessController.doPrivileged                
                           (new GetPropertyAction("file.encoding")));           
                                                                                
        if ((encoding != null) && (encoding.equals("bestfit936"))) {            
           useMS936AForGBK = true;                                              
        }                                                                       
    }                                                                           
                                ...
                                try {
                                   ...
                                   // return (CharsetProvider)epc.newInstance();
                                               ...
                                               {                               //IBM-T6_wrt_bringup
                                                       ...
                                                       return (CharsetProvider)epc.newInstance(); //IBM-T6_wrt_bringup
                                               }                               //IBM-T6_wrt_bringup
    ...
    private static Charset lookup(String charsetName) {
        ...
        /*                                                                      
         * When file.encoding="bestfit936" is used, the GBK code page           
         * has to be replaced with MS936A code page. The file encoding          
         * property "bestfit936" is used to ensure compatibility between        
         * IBM JDK and Oracle JDK as IBM GBK converter follows Unicode 3.0      
         * where as Oracle GBK converter follows Unicode 2.0 standards.         
         */                                                                     
        if ((useMS936AForGBK) && (charsetName.equals("GBK"))) {                 
           charsetName = "MS936A";                                              
        }                                                                       
		                                                                //IBM-T6_wrt_bringup
		if (!MemorySafetyService.isSafeMode())                          //IBM-T6_wrt_bringup
		{                                                               //IBM-T6_wrt_bringup
			Object[] a;                                             //IBM-T6_wrt_bringup
			if ((a = cache1) != null && charsetName.equals(a[0]))   //IBM-T6_wrt_bringup
				return (Charset)a[1];                           //IBM-T6_wrt_bringup
		}                                                               //IBM-T6_wrt_bringup
    ...
    private static Charset lookup2(String charsetName) {
		...
		{                                                               //IBM-T6_wrt_bringup
			Object[] a;                                             //IBM-T6_wrt_bringup
			if ((a = cache2) != null && charsetName.equals(a[0])) { //IBM-T6_wrt_bringup
				cache2 = cache1;                                //IBM-T6_wrt_bringup
				cache1 = a;                                     //IBM-T6_wrt_bringup
				return (Charset)a[1];                           //IBM-T6_wrt_bringup
			}                                                       //IBM-T6_wrt_bringup
		}                                                               //IBM-T6_wrt_bringup
		                                                                //IBM-T6_wrt_bringup
            ...
            (cs = lookupViaProviders(charsetName))              != null)
        {
            if(!MemorySafetyService.isSafeMode())                               //IBM-T6_wrt_bringup
			{                                                       //IBM-T6_wrt_bringup
				cache(charsetName, cs);                         //IBM-T6_wrt_bringup
            }                                                                   //IBM-T6_wrt_bringup
            return cs;
        }
