    ...
    implements DirectBuffer
{
    ...
    public float get() {
        if (RCMSupport.isRCMSupported() && fd != null) {
            return Float.intBitsToFloat(Bits.swap(unsafe.rcmGetInt(ix(nextGetIndex()))));
        }
    ...
    public FloatBuffer put(float x) {
        ...
        // add rcm code
        if (RCMSupport.isRCMSupported() && fd != null) {
            unsafe.rcmPutInt(ix(nextPutIndex()), Bits.swap(Float.floatToRawIntBits(x)));
        } else {
    ...
    public FloatBuffer put(int i, float x) {
        ...
        // add rcm code
        if (RCMSupport.isRCMSupported() && fd != null) {
            unsafe.rcmPutInt(ix(checkIndex(i)), Bits.swap(Float.floatToRawIntBits(x)));
        } else {
