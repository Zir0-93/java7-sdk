    ...
    implements Channel, InterruptibleChannel
{
    ...
    protected final void begin() {
       ...
       /* If this channel is non-blocking, skip the Thread.isInterrupted() check */ //IBM-perf_FileIO
        if (this instanceof SelectableChannel) {                                //IBM-perf_FileIO
            if (!((SelectableChannel) this).isBlocking()) {                     //IBM-perf_FileIO
                return;                                                         //IBM-perf_FileIO
            }                                                                   //IBM-perf_FileIO
        }                                                                       //IBM-perf_FileIO
                                                                                //IBM-perf_FileIO
