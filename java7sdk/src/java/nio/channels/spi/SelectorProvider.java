...
public abstract class SelectorProvider {
    ...
    public static SelectorProvider provider() {
        synchronized (lock)                                                     //IBM-T6_wrt_bringup
        {                                                                       //IBM-T6_wrt_bringup
            if (provider != null)
                return provider;
				                                                //IBM-T6_wrt_bringup
			return AccessController.doPrivileged(                   //IBM-T6_wrt_bringup
            new PrivilegedAction<SelectorProvider>()                            //IBM-T6_wrt_bringup
            {                                                                   //IBM-T6_wrt_bringup
                public SelectorProvider run()                                   //IBM-T6_wrt_bringup
                {                                                               //IBM-T6_wrt_bringup
					...
					{                                       //IBM-T6_wrt_bringup
						...
						if (loadProviderFromProperty()) //IBM-T6_wrt_bringup
							return provider;        //IBM-T6_wrt_bringup
						if (loadProviderAsService())    //IBM-T6_wrt_bringup
							return provider;        //IBM-T6_wrt_bringup
						provider = sun.nio.ch.DefaultSelectorProvider.create(); //IBM-T6_wrt_bringup
						return provider;                //IBM-T6_wrt_bringup
					}                                       //IBM-T6_wrt_bringup
