...
public interface ThreadMXBean extends PlatformManagedObject {
     ...
     * @throws IllegalArgumentException
     *             if any element in <code>ids</code> is &lt;&eq;0.
     * @throws IllegalArgumentException
...
/*
 * $Log$
 * Revision 1.5  2006/06/14 09:40:30  gharley
 * Add in the missing getThreadInfo(long[], boolean, boolean) that was inadvertantly missed last week. Update Javadoc comments for the other
 * variants to make it clear that they do not attempt to obtain any data about locks.
 * Revision 1.4 2006/06/09 16:02:20 gharley
 * Implementation of the new ThreadMXBean operations. All over bar the native
 * code. Revision 1.3 2006/06/09 12:16:33 gharley Java implementation of the
 * ThreadMXBean.findDeadlockedThreads() method. Revision 1.2 2006/06/09 11:39:33
 ...
 * ThreadMXBean methods. Revision 1.1 2005/01/11 10:56:10 gharley Initial upload
 * 
