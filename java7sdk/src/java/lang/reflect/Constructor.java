...
public final
     ...
     * always the same as the simple name of the constructor's declaring        //IBM-T6_wrt_bringup
     * class.                                                                   //IBM-T6_wrt_bringup
     */
    ...
    private ConstructorAccessor acquireConstructorAccessor() {
		...
		{                                                               //IBM-T6_wrt_bringup
			...
			tmp = reflectionFactory.newConstructorAccessor(this);   //IBM-T6_wrt_bringup
		}                                                               //IBM-T6_wrt_bringup
   ...
   String getSignature() {
    ...
    private synchronized  Map<Class<? extends Annotation>, Annotation> declaredAnnotations() {
        if (declaredAnnotations == null) {
            declaredAnnotations = getAnnotationsFromCache(getDeclaringClass(), annotations);
        }
