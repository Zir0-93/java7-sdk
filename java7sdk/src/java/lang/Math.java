...
public final class Math {
    ...
    private static synchronized Random initRNG()                                //IBM-T6_wrt_bringup
    {                                                                           //IBM-T6_wrt_bringup
        if(randomNumberGenerator==null)                                                            //IBM-T6_wrt_bringup
        {                                                                       //IBM-T6_wrt_bringup
			...
			{                                                       //IBM-T6_wrt_bringup
				...
				randomNumberGenerator = new Random();                              //IBM-T6_wrt_bringup
			}                                                       //IBM-T6_wrt_bringup
        ...
        return randomNumberGenerator;                                                              //IBM-T6_wrt_bringup
    }
