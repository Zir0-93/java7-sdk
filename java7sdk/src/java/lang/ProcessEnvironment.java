...
final class ProcessEnvironment extends HashMap<String,String>
{
    ...
    static String getenv(String name) {
        ...
        if (TenantGlobals.isTenantEnabled()) {                                  //IBM-multitenancy_management
            Map<String, String> map = TenantAccessFactory.getAccess()
                                       .getEnvironment(TenantContext.current());//IBM-multitenancy_management
            if (map != null)                                                    //IBM-multitenancy_management
                return map.get(name);                                           //IBM-multitenancy_management
    ...
    static Map<String,String> getenv() {
        if (TenantGlobals.isTenantEnabled()) {                                  //IBM-multitenancy_management
            Map<String, String> map = TenantAccessFactory.getAccess()
                                       .getEnvironment(TenantContext.current());
            if (map != null)                                                    //IBM-multitenancy_management
                return map;                                                     //IBM-multitenancy_management
        }                                                                       //IBM-multitenancy_management
    ...
    static Map<String,String> environment() {
        if (TenantGlobals.isTenantEnabled()) {                                  //IBM-multitenancy_management
            Map<String,String> map = TenantAccessFactory.getAccess()
                                       .getEnvironment(TenantContext.current());
            if (map != null) {                                                  //IBM-multitenancy_management
                ProcessEnvironment mapclone = new ProcessEnvironment();
                mapclone.putAll(map);                                           //IBM-multitenancy_management
                return (Map<String,String>) mapclone;                           //IBM-multitenancy_management
            }                                                                   //IBM-multitenancy_management
        }                                                                       //IBM-multitenancy_management
