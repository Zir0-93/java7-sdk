...
public class ThreadLocal<T> {
    ...
    ThreadLocalMap getMap(Thread t) {
        if (TenantGlobals.isTenantEnabled()) {                                  //IBM-multitenancy_management
            ...
            if (tc != null) {                                                   //IBM-multitenancy_management
                Object oMap = TenantAccessFactory.getAccess()
                                      .safeReadObj(tc, t.threadLocalsIndex);    //IBM-multitenancy_management
        ...
        if (TenantGlobals.isTenantEnabled()) {                                  //IBM-multitenancy_management
            ...
            if (tc != null) {                                                   //IBM-multitenancy_management
                ...
                TenantAccessFactory.getAccess().ensureAllocationAndWriteObj(tc, 
                                               t.threadLocalsIndex, map);       //IBM-multitenancy_management
    ...
    static class ThreadLocalMap {
        ...
        private void set(ThreadLocal key, Object value) {
            ...
            if(! MemorySafetyService.canCurrentThreadAccessHeap()) {            //IBM-T6_wrt_bringup
	            long oldMemory = -1;                                        //IBM-T6_wrt_bringup
	            try {                                                       //IBM-T6_wrt_bringup
	            	oldMemory = MemorySafetyService.enterObjectsMemoryArea(tab);  //IBM-T6_wrt_bringup
	            	tab[i] = new Entry(key, value);                     //IBM-T6_wrt_bringup
        ...
        private void replaceStaleEntry(ThreadLocal key, Object value,
            ...
            if(! MemorySafetyService.canCurrentThreadAccessHeap()) {            //IBM-T6_wrt_bringup
	            ...
	            try {                                                       //IBM-T6_wrt_bringup
	            	oldMemory = MemorySafetyService.enterObjectsMemoryArea(tab);  //IBM-T6_wrt_bringup
	                tab[staleSlot] = new Entry(key, value);                 //IBM-T6_wrt_bringup
	            } finally {                                                 //IBM-T6_wrt_bringup
	            	MemorySafetyService.exitLastMemoryArea(oldMemory);  //IBM-T6_wrt_bringup
	            }                                                           //IBM-T6_wrt_bringup
            } else {                                                            //IBM-T6_wrt_bringup
        ...
        private void resize() {
            ...
            int newLen = oldLen * 2;
            Entry[] newTab = null;                                              //IBM-T6_wrt_bringup
            if(! MemorySafetyService.canCurrentThreadAccessHeap()) {            //IBM-T6_wrt_bringup
	            long oldMemory = -1;                                        //IBM-T6_wrt_bringup
	            try {                                                       //IBM-T6_wrt_bringup
	            	oldMemory = MemorySafetyService.enterObjectsMemoryArea(oldTab);  //IBM-T6_wrt_bringup
	                newTab = new Entry[newLen];                             //IBM-T6_wrt_bringup
	            } finally {                                                 //IBM-T6_wrt_bringup
	            	MemorySafetyService.exitLastMemoryArea(oldMemory);  //IBM-T6_wrt_bringup
	            }                                                           //IBM-T6_wrt_bringup
            } else {                                                            //IBM-T6_wrt_bringup
