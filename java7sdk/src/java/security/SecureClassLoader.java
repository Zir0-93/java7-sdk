            ...
            if (pd == null) {
				...
				{                                               //IBM-T6_wrt_bringup
					oldMemory = MemorySafetyService.enterSafeMemoryArea(); //IBM-T6_wrt_bringup
	                		PermissionCollection perms = getPermissions(cs); //IBM-T6_wrt_bringup
	                		pd = new ProtectionDomain(cs, perms, this, null); //IBM-T6_wrt_bringup
	                		pdcache.put(cs, pd);                    //IBM-T6_wrt_bringup
				}                                               //IBM-T6_wrt_bringup
