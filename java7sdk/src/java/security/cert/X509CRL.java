...
public abstract class X509CRL extends CRL implements X509Extension {
    ...
    public boolean equals(Object other) {
        ...
        try {
            byte[] thisCRL = this.getEncoded();                                 //IBM-security_tivoli_support
            byte[] otherCRL = ((X509CRL) other).getEncoded();                   //IBM-security_tivoli_support
    ...
    public int hashCode() {
        int retval = 0;
        try {
            byte[] crlData = this.getEncoded();                                 //IBM-security_tivoli_support
    ...
    public X500Principal getIssuerX500Principal() {
        ...
        if (getIssuerDN() == null) {                                            //IBM-security_tivoli_support
            throw new IllegalStateException("issuer may not be null");          //IBM-security_tivoli_support
        }                                                                       //IBM-security_tivoli_support
                                                                                //IBM-security_tivoli_support
        try {                                                                   //IBM-security_tivoli_support
            issuerPrincipal = new X500Principal(getIssuerDN().getName());       //IBM-security_tivoli_support
        } catch (Exception e) {                                                 //IBM-security_tivoli_support
            RuntimeException re = new RuntimeException(                         //IBM-security_tivoli_support
                    "unable to instantiate X500Principal");                     //IBM-security_tivoli_support
            re.initCause(e);                                                    //IBM-security_tivoli_support
            throw re;                                                           //IBM-security_tivoli_support
        }                                                                       //IBM-security_tivoli_support
        }
