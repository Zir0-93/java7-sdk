...
public abstract class Certificate implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        try {
            byte[] thisCert = this.getEncoded();                                 //IBM-security_tivoli_support
            byte[] otherCert = ((Certificate) other).getEncoded();               //IBM-security_tivoli_support
    ...
    public int hashCode() {
        int retval = 0;
        try {
            byte[] certData = this.getEncoded();                                //IBM-security_tivoli_support
