...
class Win32FileSystem extends FileSystem {
    ...
    /*JSE-1216 Declaring native methods*/                                       //IBM-net_perf
    public native String collapsePath(String path) throws IOException;          //IBM-net_perf
    public native String getBaseName(String path) throws IOException;           //IBM-net_perf
    public native String getComponentName(String path) throws IOException;      //IBM-net_perf

    /* JSE-1216 Overrides method on FileSystem class to provide platform specific  //IBM-net_perf
     * canonical path.                                                          //IBM-net_perf
     */                                                                         //IBM-net_perf
    public CanonicalPath getCanonicalPath(String path, boolean directory) {     //IBM-net_perf
        return new Win32CanonicalPath(path, directory);                         //IBM-net_perf
    }                                                                           //IBM-net_perf
                                                                                //IBM-net_perf
                                                                                //IBM-net_perf
    /* -- Attribute accessors -- */
