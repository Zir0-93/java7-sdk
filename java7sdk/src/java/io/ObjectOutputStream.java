    ...
    extends OutputStream implements ObjectOutput, ObjectStreamConstants
{
	...
	private static final int TC_PACKED = 0x99;
    ...
    public ObjectOutputStream(OutputStream out) throws IOException {
        if(out instanceof com.ibm.jvm.io.ConsolePrintStream) {                  //IBM-zos_bringup
                                                                                //IBM-zos_bringup
            ((com.ibm.jvm.io.ConsolePrintStream)out).setConversionRequired(false); //IBM-zos_bringup
        }                                                                       //IBM-zos_bringup
                                                                                //IBM-zos_bringup
        verifySubclass();
    ...
    private void verifySubclass() {
		...
		if(MemorySafetyService.isSafeMode())                            //IBM-T6_wrt_bringup
        	if (auditSubclass(cl)) return;                                  //IBM-T6_wrt_bringup
			                                                        //IBM-T6_wrt_bringup
        SecurityManager sm = System.getSecurityManager();
        if (sm == null) {
            return;
	...
	/**
	 *  Writes a Packed Object in to the stream using com.ibm.jvm.PackedObject Implementation
	 * @param obj
	 * @throws IOException
	 */
	private void writePacked(Object obj) throws IOException
	{
		bout.writeByte(TC_PACKED);
