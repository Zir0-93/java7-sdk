...
public class RandomAccessFile implements DataOutput, DataInput, Closeable {
    ...
    public void close() throws IOException {
        synchronized (closeLock) {
           ...
           */
          if ((fd.decrementAndGetUseCount() <= 0) || CloseFDWithStream) {
            close0();
          }
    }
    ...
    static {
        initIDs();
        CloseFDWithStream = !((String)java.security.AccessController.doPrivileged(
            new sun.security.action.GetPropertyAction(
                "com.ibm.streams.CloseFDWithStream", "true"))).equalsIgnoreCase("false");
    }
}
//IBM-T6_FD_reference_counting
//IBM-perf_FileIO
