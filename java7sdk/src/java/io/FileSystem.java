...
abstract class FileSystem {
    ...
    public abstract String canonicalize(String path) throws IOException;
                                                                                //IBM-net_perf
    /*JSE-1216 Get a Canonical path object */                                   //IBM-net_perf
    public CanonicalPath getCanonicalPath(String path, boolean directory) {     //IBM-net_perf
        return new CanonicalPath(path, directory);                              //IBM-net_perf
    }                                                                           //IBM-net_perf
    ...
    static boolean useCanonCaches      = !MemorySafetyService.isSafeMode();     //IBM-T6_wrt_bringup
    static boolean useCanonPrefixCache = !MemorySafetyService.isSafeMode();     //IBM-T6_wrt_bringup
