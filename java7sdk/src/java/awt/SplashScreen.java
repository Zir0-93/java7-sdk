        ...
        synchronized (SplashScreen.class) {
            ...
            if (imageURL == null) {
                try {
                    ...
                    String osname = java.security.AccessController.doPrivileged( //IBM-zos_ebcdic
                            new sun.security.action.GetPropertyAction("os.name")); //IBM-zos_ebcdic
                    if(osname.equals("z/OS")){                                  //IBM-zos_ebcdic
                        try {                                                   //IBM-zos_ebcdic
                            if(fileName!=null){                                 //IBM-zos_ebcdic
                                byte[] b = fileName.getBytes("IBM-1047");       //IBM-zos_ebcdic
                                fileName = new String(b, "US-ASCII");           //IBM-zos_ebcdic
                            }                                                   //IBM-zos_ebcdic
                            if(jarName!=null){                                  //IBM-zos_ebcdic
                                byte[] b = jarName.getBytes("IBM-1047");        //IBM-zos_ebcdic
                                jarName = new String(b, "US-ASCII");                        		 //IBM-zos_ebcdic
                            }                                                   //IBM-zos_ebcdic
                        } catch (java.io.UnsupportedEncodingException e) {      //IBM-zos_ebcdic
                            //Ignore                                            //IBM-zos_ebcdic
                        }                                                       //IBM-zos_ebcdic
                    }                                                           //IBM-zos_ebcdic
                                                                                //IBM-zos_ebcdic
                    if (fileName != null) {
