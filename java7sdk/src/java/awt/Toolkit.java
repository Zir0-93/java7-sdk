    ...
    public static synchronized Toolkit getDefaultToolkit() {
        if (toolkit == null) {
            try {
                ...
                // ------------------------------------------------------------------------------------------ //IBM-T6_awt_bringup
                // Not to disable JITing as for applications that accidentally pull in awt (because some other  //IBM-T6_awt_bringup
                // important methods don't get compiled while the awt framework has the compiler disabled). //IBM-T6_awt_bringup
                //java.lang.Compiler.disable();                                 //IBM-T6_awt_bringup
                ...
                //java.lang.Compiler.enable();                                  //IBM-T6_awt_bringup
            }
        }
        return toolkit;
    }
