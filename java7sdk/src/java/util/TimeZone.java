...
import com.ibm.jvm.util.GlobalMap;                                              //IBM-T6_wrt_bringup
...
abstract public class TimeZone implements Serializable, Cloneable {
    ...
    new sun.security.action.GetPropertyAction("jdk.util.TimeZone.allowSetDefault")) != null;
                                                                            ...
                                                                            //IBM-T6_wrt_bringup
    /**                                                                     //IBM-T6_wrt_bringup
     * Cache to hold the SimpleDateFormat objects for a Locale.                 //IBM-T6_wrt_bringup
    */                                                                         //IBM-T6_wrt_bringup
    private static Hashtable cachedLocaleData = new Hashtable(3);               //IBM-T6_wrt_bringup
 


    // A light global cache for timezones - ibm@109823                      //IBM-T6_wrt_bringup
    private static GlobalMap<String, TimeZone> immortalCache = new GlobalMap<String, TimeZone>(); //IBM-T6_wrt_bringup
    ...
    private static synchronized TimeZone setDefaultZone() {
		...
		/*                                                              //IBM-T6_wrt_bringup
        ** Start ibm@109823                                                     //IBM-T6_wrt_bringup
        ** Get the timezone from the cache if it is existing already            //IBM-T6_wrt_bringup
        ** in the immortal                                                      //IBM-T6_wrt_bringup
        */                                                                      //IBM-T6_wrt_bringup
        if(MemorySafetyService.isSafeMode())                                    //IBM-T6_wrt_bringup
        {                                                                       //IBM-T6_wrt_bringup
            tz = immortalCache.getItem(zoneID);                                 //IBM-T6_wrt_bringup
                                                                                //IBM-T6_wrt_bringup
            if(tz != null) {                                                    //IBM-T6_wrt_bringup
                final String id = zoneID;                                       //IBM-T6_wrt_bringup
                AccessController.doPrivileged(new PrivilegedAction<Object>() {   //IBM-T6_wrt_bringup
                    public Object run() {                                       //IBM-T6_wrt_bringup
                        System.setProperty("user.timezone", id);                //IBM-T6_wrt_bringup
                        return null;                                            //IBM-T6_wrt_bringup
                    }                                                           //IBM-T6_wrt_bringup
                });                                                             //IBM-T6_wrt_bringup
                                                                                //IBM-T6_wrt_bringup
                // Start ibm@121118                                             //IBM-T6_wrt_bringup
                if(hasPermission()) {                                           //IBM-T6_wrt_bringup
                    defaultTimeZone = tz;                                       //IBM-T6_wrt_bringup
                } else {                                                        //IBM-T6_wrt_bringup
                    setDefaultInAppContext(tz);                                 //IBM-T6_wrt_bringup
                }                                                               //IBM-T6_wrt_bringup
                // End ibm@121118                                               //IBM-T6_wrt_bringup
                return tz;                                                      //IBM-T6_wrt_bringup
            }                                                                   //IBM-T6_wrt_bringup
        }                                                                       //IBM-T6_wrt_bringup
        /*                                                                      //IBM-T6_wrt_bringup
        ** End ibm@109823                                                       //IBM-T6_wrt_bringup
        */                                                                      //IBM-T6_wrt_bringup
		                                                                //IBM-T6_wrt_bringup
		...
		{                                                               //IBM-T6_wrt_bringup
			...
			tz = getTimeZone(zoneID, false);                        //IBM-T6_wrt_bringup
		}                                                               //IBM-T6_wrt_bringup
        ...
        if (tz == null) {
			...
			{                                                       //IBM-T6_wrt_bringup
				oldMemory = MemorySafetyService.enterSafeMemoryArea(); //IBM-T6_wrt_bringup
				tz = getTimeZone(zoneID, true);                 //IBM-T6_wrt_bringup
			}                                                       //IBM-T6_wrt_bringup
			finally                                                 //IBM-T6_wrt_bringup
			{                                                       //IBM-T6_wrt_bringup
				MemorySafetyService.exitLastMemoryArea(oldMemory); //IBM-T6_wrt_bringup
