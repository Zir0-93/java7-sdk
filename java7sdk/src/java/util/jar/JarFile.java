...
class JarFile extends ZipFile {
	...
	private Manifest manRT;                                                 //IBM-T6_wrt_bringup
    ...
    private Manifest getManifestFromReference() throws IOException {
		...
		{                                                               //IBM-T6_wrt_bringup
			return getManifestRT();                                     /*ibm@99278*/ //IBM-T6_wrt_bringup
	    }                                                                   //IBM-T6_wrt_bringup
	...
	/*                                                                      //IBM-T6_wrt_bringup
     * Created for ibm@99278 - should match getManifest method above.           //IBM-T6_wrt_bringup
     */                                                                         //IBM-T6_wrt_bringup
    private Manifest getManifestRT() throws IOException                         //IBM-T6_wrt_bringup
    {                                                                           //IBM-T6_wrt_bringup
		if (manRT == null)                                              //IBM-T6_wrt_bringup
		{                                                               //IBM-T6_wrt_bringup
            JarEntry manEntry = getManEntry();                                  //IBM-T6_wrt_bringup
			                                                        //IBM-T6_wrt_bringup
			// If found then load the manifest                      //IBM-T6_wrt_bringup
			if (manEntry != null)                                   //IBM-T6_wrt_bringup
			{                                                       //IBM-T6_wrt_bringup
				if (verify)                                     //IBM-T6_wrt_bringup
				{                                               //IBM-T6_wrt_bringup
					byte[] b = getBytes(manEntry);          //IBM-T6_wrt_bringup
					ByteArrayInputStream bais = new ByteArrayInputStream(b);  //IBM-T6_wrt_bringup
					...
					{                                       //IBM-T6_wrt_bringup
						...
						manRT = new Manifest(bais); 							 //IBM-T6_wrt_bringup
					}                                       //IBM-T6_wrt_bringup
					catch ( Exception e )                   //IBM-T6_wrt_bringup
					{                                       //IBM-T6_wrt_bringup
					 	throw new IOException("Unable to create Manifest");  //IBM-T6_wrt_bringup
					}                                       //IBM-T6_wrt_bringup
					...
					{                                       //IBM-T6_wrt_bringup
						MemorySafetyService.exitLastMemoryArea(oldMemory); //IBM-T6_wrt_bringup
					                                        ...
					                                        //IBM-T6_wrt_bringup
					                                        //IBM-T6_wrt_bringup
					if (!jvInitialized) {                   //IBM-T6_wrt_bringup
						jv = new JarVerifier(b);        //IBM-T6_wrt_bringup
					}                                       //IBM-T6_wrt_bringup
				}                                               //IBM-T6_wrt_bringup
				else                                            //IBM-T6_wrt_bringup
				{                                               //IBM-T6_wrt_bringup
					InputStream is = super.getInputStream(manEntry); //IBM-T6_wrt_bringup
					long oldMemory = -1;                    //IBM-T6_wrt_bringup
					try                                     //IBM-T6_wrt_bringup
					{                                       //IBM-T6_wrt_bringup
						oldMemory = MemorySafetyService.enterObjectsMemoryArea(this);  //IBM-T6_wrt_bringup
						manRT = new Manifest(is);       //IBM-T6_wrt_bringup
					}                                       //IBM-T6_wrt_bringup
					catch ( Exception e )                   //IBM-T6_wrt_bringup
					{                                       //IBM-T6_wrt_bringup
						throw new IOException("Unable to create Manifest");  //IBM-T6_wrt_bringup
		...
		return manRT;                                                   //IBM-T6_wrt_bringup
    }                                                                           //IBM-T6_wrt_bringup
        ...
        if (javaHome == null) {
            javaHome = AccessController.doPrivileged(
                new GetPropertyAction("java.home"));
		                                                                ...
		                                                                //IBM-T6_wrt_bringup
		String name = getName();                                        //IBM-T6_wrt_bringup
        String localJavaHome = javaHome;                                        //IBM-T6_wrt_bringup
                                                                                //IBM-T6_wrt_bringup
		if (MemorySafetyService.isSafeMode()) {                         //IBM-T6_wrt_bringup
            if (name.startsWith(localJavaHome)) {                               //IBM-T6_wrt_bringup
                if (name.endsWith("rt.jar") ||                                  //IBM-T6_wrt_bringup
                    name.endsWith("sunrsasign.jar") ||                          //IBM-T6_wrt_bringup
                    name.endsWith("jsse.jar") ||                                //IBM-T6_wrt_bringup
                    name.endsWith("jce.jar") ||                                 //IBM-T6_wrt_bringup
                    name.endsWith("charsets.jar") ||                            //IBM-T6_wrt_bringup
                    name.endsWith("dnsns.jar") ||                               //IBM-T6_wrt_bringup
                    name.endsWith("ldapsec.jar") ||                             //IBM-T6_wrt_bringup
                    name.endsWith("localedata.jar") ||                          //IBM-T6_wrt_bringup
                    name.endsWith("sunjce_provider.jar") ||                     //IBM-T6_wrt_bringup
                    name.endsWith("sunpkcs11.jar")) {                           //IBM-T6_wrt_bringup
                    return true;                                                //IBM-T6_wrt_bringup
                }                                                               //IBM-T6_wrt_bringup
            }                                                                   //IBM-T6_wrt_bringup
            return false;                                                       //IBM-T6_wrt_bringup
        }                                                                       //IBM-T6_wrt_bringup
		                                                                //IBM-T6_wrt_bringup
        if (jarNames == null) {
