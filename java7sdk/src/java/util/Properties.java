...
class Properties extends Hashtable<Object,Object> {
    ...
    public synchronized void load(InputStream inStream) throws IOException {
         ...
         bis.reset();
         if(isAscii){
             load0(new LineReader(bis, "ISO8859-1"));
         }else{
             load0(new LineReader(bis));
    }
    }
    ...
    class LineReader {
        ...
        public LineReader(InputStream inStream, String charSetName) {
            try {
    ...
    private boolean isAscii(InputStream inStream) throws IOException{
        byte b;
