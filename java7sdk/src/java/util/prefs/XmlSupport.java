...
class XmlSupport {
    ...
    {
        try {
            /*JSE-5742*/                                                        //IBM-ibm_xml
           TransformerFactory tf = TransformerFactory.newInstance();            //IBM-ibm_xml
            /*try {                                                             //IBM-ibm_xml
           ...
           t.setOutputProperty("{http://xml.apache.org/xalan}indent-amount", "2"); //JSE-5742 //IBM-ibm_xml
