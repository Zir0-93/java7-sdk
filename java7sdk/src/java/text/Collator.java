    ...
    implements java.util.Comparator<Object>, Cloneable
{
    ...
    {
        //Collator result = (Collator) cache.get(desiredLocale);                //IBM-T6_wrt_bringup
        Collator result = null;                                                 //IBM-T6_wrt_bringup
                                                                                //IBM-T6_wrt_bringup
        //Lighter chaching in Immortal for realtime - ibm@104704                //IBM-T6_wrt_bringup
        if(!MemorySafetyService.isSafeMode())                                   //IBM-T6_wrt_bringup
        {                                                                       //IBM-T6_wrt_bringup
            result = (Collator) cache.get(desiredLocale);                       //IBM-T6_wrt_bringup
        }                                                                       //IBM-T6_wrt_bringup
        ...
        {                                                                       //IBM-T6_wrt_bringup
			...
			{                                                       //IBM-T6_wrt_bringup
				...
				result = (Collator) immortalCache.getItem(desiredLocale); //IBM-T6_wrt_bringup
			}                                                       //IBM-T6_wrt_bringup
        ...
        // manager.
        String colString = "";
        int decomp = CANONICAL_DECOMPOSITION;                                   //IBM-T6_wrt_bringup
        try {
            ResourceBundle resource = LocaleData.getCollationData(desiredLocale);
            colString = resource.getString("Rule");
            decomp = ((Integer)resource.getObject("CollationDecomp")).intValue(); //IBM-T6_wrt_bringup
        ...
        {
			/*                                                      //IBM-T6_wrt_bringup
			result = new RuleBasedCollator( CollationRules.DEFAULTRULES + //IBM-T6_wrt_bringup
							     			colString, CANONICAL_DECOMPOSITION ); //IBM-T6_wrt_bringup
			*/                                                      //IBM-T6_wrt_bringup
			long oldMemory = -1;                                    //IBM-T6_wrt_bringup
			try                                                     //IBM-T6_wrt_bringup
			{                                                       //IBM-T6_wrt_bringup
        ...
        catch(ParseException foo)
        {
            ...
            catch (ParseException bar) {                                        //IBM-T6_wrt_bringup
                // do nothing
            }
        }
                                                                                //IBM-T6_wrt_bringup
        ...
        //cache.put(desiredLocale,result);                                      //IBM-T6_wrt_bringup
                                                                                //IBM-T6_wrt_bringup
        //Lighter caching in Immortal for realtime - ibm@104704                 //IBM-T6_wrt_bringup
        if(!MemorySafetyService.isSafeMode()) {                                 //IBM-T6_wrt_bringup
            cache.put(desiredLocale,result);                                    //IBM-T6_wrt_bringup
        } else {                                                                //IBM-T6_wrt_bringup
            immortalCache.putItem(desiredLocale,result);                        //IBM-T6_wrt_bringup
        }                                                                       //IBM-T6_wrt_bringup
    ...
    // Use a lighter GlobalMap to cahche in realtime - ibm@104704               //IBM-T6_wrt_bringup
    private static GlobalMap<Locale,Collator> immortalCache = new GlobalMap<Locale,Collator>(); //IBM-T6_wrt_bringup
                                                                                //IBM-T6_wrt_bringup
    //
