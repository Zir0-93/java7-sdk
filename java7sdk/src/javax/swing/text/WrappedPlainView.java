...
public class WrappedPlainView extends BoxView implements TabExpander {
    ...
    class WrappedLine extends View {
        ...
        final int[] getLineEnds() {
           int start = getStartOffset();                                        //IBM-swing_bringup
           if (lineCache == null && start!=0) {                                 //IBM-swing_bringup
               return null;                                                     //IBM-swing_bringup
            } else {
               if(start ==0){                                                   //IBM-swing_bringup
                   return breakLines(start);                                    //IBM-swing_bringup
               } else {                                                         //IBM-swing_bringup
                   int[] lineEnds = lineCache.get();                            //IBM-swing_bringup
                   if (lineEnds == null) {                                      //IBM-swing_bringup
                        // Cache was GC'ed, so rebuild it                       //IBM-swing_bringup
                      return breakLines(start);                                 //IBM-swing_bringup
                   } else {                                                     //IBM-swing_bringup
                       return lineEnds;                                         //IBM-swing_bringup
                  }                                                             //IBM-swing_bringup
               }                                                                //IBM-swing_bringup
            }
        }
