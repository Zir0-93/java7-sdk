                    ...
                    if (dot != mark) {
                        ...
                        if (dot > 1) {
                            ...
                            if (c0 >= '\uD800' && c0 <= '\uDBFF' &&
                                c1 >= '\uDC00' && c1 <= '\uDFFF') {
                                delChars = 2;
                                                                                //IBM-T6_input_method_framework
                                // for Variation Selector, 0x0E01xx (DB40, DDxx), //IBM-T6_input_method_framework
                                //  both characters of base and variation selector should be deleted. //IBM-T6_input_method_framework
                                if (sun.font.CharToGlyphMapper.isVariationSelectorSupported() && //IBM-T6_input_method_framework
                                    dot > 2 && c0 == '\uDB40' &&                //IBM-T6_input_method_framework
                                    c1 >= '\uDD00' && c1 <= '\uDDEF') {         //IBM-T6_input_method_framework
                                    String targetChars = doc.getText(0,dot);    //IBM-T6_input_method_framework
                                    int pre = targetChars.codePointBefore(dot-2); //IBM-T6_input_method_framework
                                    int preBase = pre;                          //IBM-T6_input_method_framework
                                    int vsCount = 1;                            //IBM-T6_input_method_framework
                                    while(preBase >= 0xE0100 && preBase <= 0xE01FF) { //IBM-T6_input_method_framework
                                        vsCount++;                              //IBM-T6_input_method_framework
                                        if (dot <= 2*vsCount) {                 //IBM-T6_input_method_framework
                                            preBase = 0;                        //IBM-T6_input_method_framework
                                            break;                              //IBM-T6_input_method_framework
                                        }                                       //IBM-T6_input_method_framework
                                        preBase = targetChars.codePointBefore(dot - 2*vsCount); //IBM-T6_input_method_framework
                                    }                                           //IBM-T6_input_method_framework
                                    if (preBase == 0 ||                         //IBM-T6_input_method_framework
                                        sun.font.CharToGlyphMapper.isBaseChar(preBase) == false){ //IBM-T6_input_method_framework
                                        vsCount--;                              //IBM-T6_input_method_framework
                                    }                                           //IBM-T6_input_method_framework
                                    if ((vsCount%2) == 1){                      //IBM-T6_input_method_framework
                                        if (pre >= 0x10000){                    //IBM-T6_input_method_framework
                                            delChars = 4;                       //IBM-T6_input_method_framework
                                        }else{                                  //IBM-T6_input_method_framework
                                            delChars = 3;                       //IBM-T6_input_method_framework
                                        }                                       //IBM-T6_input_method_framework
                                    }                                           //IBM-T6_input_method_framework
                                }                                               //IBM-T6_input_method_framework
                            }
                ...
                try {
                    ...
                    if (dot != mark) {
                        ...
                        if (dot < doc.getLength() - 1) {
                            ...
                            char c0 = dotChars.charAt(0);
                            char c1 = dotChars.charAt(1);
                            int baseChar=(int)c0;                               //IBM-T6_input_method_framework

                            if (c0 >= '\uD800' && c0 <= '\uDBFF' &&
                                c1 >= '\uDC00' && c1 <= '\uDFFF') {
                                delChars = 2;
                                baseChar = (c0-0xD800)*0x400 + c1-0xDC00 + 0x10000; //IBM-T6_input_method_framework
                            }                                                   //IBM-T6_input_method_framework
                                                                                //IBM-T6_input_method_framework
                            // for Variation Selector,                          //IBM-T6_input_method_framework
                            //  both characters of base and variation selector should be deleted. //IBM-T6_input_method_framework
                            if (sun.font.CharToGlyphMapper.isVariationSelectorSupported() && //IBM-T6_input_method_framework
                                sun.font.CharToGlyphMapper.isBaseChar(baseChar) && //IBM-T6_input_method_framework
                                dot < doc.getLength() -delChars -1) {           //IBM-T6_input_method_framework
                                String nextChars = doc.getText(dot+delChars, 2); //IBM-T6_input_method_framework
                                char c2 = nextChars.charAt(0);                  //IBM-T6_input_method_framework
                                char c3 = nextChars.charAt(1);                  //IBM-T6_input_method_framework
                                if (c2 == '\uDB40' && c3 >= '\uDD00' && c3 <= '\uDDEF') { //IBM-T6_input_method_framework
                                    delChars += 2;                              //IBM-T6_input_method_framework
                                }                                               //IBM-T6_input_method_framework
                            }
                        }
