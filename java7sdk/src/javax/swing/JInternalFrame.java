...
///////////////////////////
    ...
    */
    ...
    public void hide() {
       /* Repainting code is added since while hiding the internal frame        //IBM-swing_bringup
          repainting is not done in the area where the internal frame was...    //IBM-swing_bringup
          So the repaint() method is called for the parent of the internal frame //IBM-swing_bringup
          to refresh the rectangle bounded by the internal frame...             //IBM-swing_bringup
       */                                                                       //IBM-swing_bringup
        Container p = getParent();                                              //IBM-swing_bringup
        if (isIcon()) {
            getDesktopIcon().setVisible(false);
        }
        else if (p != null) {                                                   //IBM-swing_bringup
          Rectangle r = getBounds();                                            //IBM-swing_bringup
          p.repaint(r.x,r.y,r.width,r.height);                                  //IBM-swing_bringup
        }                                                                       //IBM-swing_bringup
        super.hide();
    }
