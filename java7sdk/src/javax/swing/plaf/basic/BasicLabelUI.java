    ...
    private static class Actions extends UIAction {
        ...
        private void doPress(JLabel label) {
            ...
            if (labelFor != null && labelFor.isEnabled()) {
                ...
                // with sticky keys on windowsXP, sometimes the focus event for label happens after release of ALT @JSE-2627 //IBM-accessibility
                inputMap.put(KeyStroke.getKeyStroke(dka, 0, true), RELEASE);    //IBM-accessibility
                label.requestFocus();
            }
        }
        ...
        private void doRelease(JLabel label) {
            ...
            if (labelFor != null && labelFor.isEnabled()) {
                ...
                if (inputMap != null) {
                    ...
                    inputMap.remove(KeyStroke.getKeyStroke(label.getDisplayedMnemonic(), 0, true)); //IBM-accessibility
                }
