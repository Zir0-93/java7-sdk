    ...
    public class MouseHandler extends MouseAdapter implements MouseMotionListener
 {
    ...
    private class Handler implements CellEditorListener, FocusListener,
        ...
        public void focusGained(FocusEvent e) {
            if(tree != null) {
                Rectangle                 pBounds;
               /* Making the 0th row as lead selection path to make             //IBM-swing_bringup
                  the focus visible to the user. Though the 0th row wil be high lighted during //IBM-swing_bringup
                  focus, initial row selection will be false, and hence the 0th row wouldn't have got selected //IBM-swing_bringup
               */                                                               //IBM-swing_bringup
                if((tree.getLeadSelectionPath()==null) && (tree.getRowCount()>0)){ //IBM-swing_bringup
                    setLeadSelectionPath(getPathForRow(tree, 0), false);        //IBM-swing_bringup
                }                                                               //IBM-swing_bringup
