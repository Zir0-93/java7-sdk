...
public class BasicComboBoxUI extends ComboBoxUI {
    ...
    public void installUI( JComponent c ) {
       ...
       keySelectionManager = null;                                              //IBM-accessibility
       /*                                                                       //IBM-accessibility
        ...
        if ( si < comboBox.getModel().getSize() - 1 ) {
            ...
            if ( !isTableCellEditor ) {
                if (!(UIManager.getBoolean("ComboBox.noActionOnKeyNavigation") && comboBox.isPopupVisible())) {
                    comboBox.getModel().setSelectedItem(                        //IBM-accessibility
                             comboBox.getModel().getElementAt(si+1));           //IBM-accessibility
                }
            }
            comboBox.repaint();
        }
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed( ActionEvent e ) {
            ...
            if (key == HIDE) {
                ...
                comboBox.setPopupVisible(false);
                     ...
                     key == HOME || key == END) {
                JList listBox=ui.listBox;
                int index = getNextIndex(comboBox, key,listBox);
        ...
        private int getNextIndex(JComboBox comboBox, String key, JList listBox) {
           ...
           return listBox.getSelectedIndex();                                   //IBM-accessibility
        }
