...
public class MetalComboBoxUI extends BasicComboBoxUI {
    ...
    private ActionListener editorActionListener;                                //IBM-accessibility
                                                                                //IBM-accessibility
    ...
    protected ComboPopup createPopup() {
        return super.createPopup();
                                                                                ...
                                                                                //IBM-accessibility
    protected KeyListener createKeyListener() {                                 //IBM-accessibility
        return new NoSelectKeyHandler();                                        //IBM-accessibility
    }                                                                           //IBM-accessibility
    private class NoSelectKeyHandler extends KeyAdapter {                       //IBM-accessibility
        private int selectionForKey(char aKey) {                                //IBM-accessibility
            int i,c;                                                            //IBM-accessibility
            int currentSelection = -1;                                          //IBM-accessibility
            Object selectedItem = listBox.getSelectedValue();                   //IBM-accessibility
            String v;                                                           //IBM-accessibility
            String pattern;                                                     //IBM-accessibility
            ListModel aModel = listBox.getModel();                              //IBM-accessibility
                                                                                //IBM-accessibility
            if ( selectedItem != null ) {                                       //IBM-accessibility
                                                                                //IBM-accessibility
                for ( i=0,c=aModel.getSize();i<c;i++ ) {                        //IBM-accessibility
                    if ( selectedItem == aModel.getElementAt(i) ) {             //IBM-accessibility
                        currentSelection  =  i;                                 //IBM-accessibility
                        break;                                                  //IBM-accessibility
                                                                                ...
                                                                                //IBM-accessibility
            pattern = ("" + aKey).toLowerCase();                                //IBM-accessibility
            aKey = pattern.charAt(0);                                           //IBM-accessibility
                                                                                //IBM-accessibility
            for ( i = ++currentSelection, c = aModel.getSize() ; i < c ; i++ ) { //IBM-accessibility
                if (aModel.getElementAt(i) != null && aModel.getElementAt(i).toString() != null) { //IBM-accessibility
                    v = aModel.getElementAt(i).toString().toLowerCase();        //IBM-accessibility
                    if ( v.length() > 0 && v.charAt(0) == aKey )                //IBM-accessibility
                        return i;                                               //IBM-accessibility
                }                                                               //IBM-accessibility
            }                                                                   //IBM-accessibility
                                                                                //IBM-accessibility
            for ( i = 0 ; i < currentSelection ; i ++ ) {                       //IBM-accessibility
                if (aModel.getElementAt(i) != null && aModel.getElementAt(i).toString() != null) { //IBM-accessibility
                    v = aModel.getElementAt(i).toString().toLowerCase();        //IBM-accessibility
                    if ( v.length() > 0 && v.charAt(0) == aKey )                //IBM-accessibility
                        return i;                                               //IBM-accessibility
            ...
            return -1;                                                          //IBM-accessibility
        }                                                                       //IBM-accessibility
                                                                                //IBM-accessibility
        private boolean selectWithKeyCharNoAction(char keyChar) {               //IBM-accessibility
            int index = selectionForKey(keyChar);                               //IBM-accessibility
            if ( index != -1 ) {                                                //IBM-accessibility
                // the popup has to be showing now, otherwise the selected item //IBM-accessibility
                // will not be seen                                             //IBM-accessibility
                comboBox.setPopupVisible(true);                                 //IBM-accessibility
                listBox.setSelectedIndex(index);                                //IBM-accessibility
                listBox.ensureIndexIsVisible(index);                            //IBM-accessibility
                ...
                return false;                                                   //IBM-accessibility
                                                                                ...
                                                                                //IBM-accessibility
        public void keyPressed( KeyEvent e ) {                                  //IBM-accessibility
            if ( comboBox.isEnabled() &&                                        //IBM-accessibility
                 !isNavigationKey( e.getKeyCode() ) &&                          //IBM-accessibility
                 isTypeAheadKey( e ) ) {                                        //IBM-accessibility
                                                                                //IBM-accessibility
                if (comboBox.getKeySelectionManager() != null) {                //IBM-accessibility
                    if ( comboBox.selectWithKeyChar(e.getKeyChar()) ) {         //IBM-accessibility
                        e.consume();                                            //IBM-accessibility
                    }                                                           //IBM-accessibility
                } else {                                                        //IBM-accessibility
                    if (selectWithKeyCharNoAction(e.getKeyChar()) ) {           //IBM-accessibility
                        e.consume();                                            //IBM-accessibility
                    }                                                           //IBM-accessibility
                }                                                               //IBM-accessibility
            }                                                                   //IBM-accessibility
                                                                                ...
                                                                                //IBM-accessibility
        boolean isTypeAheadKey( KeyEvent e ) {                                  //IBM-accessibility
            return !e.isAltDown() && !e.isControlDown() && !e.isMetaDown();     //IBM-accessibility
        }                                                                       //IBM-accessibility
    }                                                                           //IBM-accessibility
                                                                                //IBM-accessibility
    protected void selectNextPossibleValue() {                                  //IBM-accessibility
        int si = listBox.getSelectedIndex();                                    //IBM-accessibility
        if ( si < comboBox.getModel().getSize() - 1 ) {                         //IBM-accessibility
            listBox.setSelectedIndex( si + 1 );                                 //IBM-accessibility
            listBox.ensureIndexIsVisible( si + 1 );                             //IBM-accessibility
            comboBox.repaint();                                                 //IBM-accessibility
        }                                                                       //IBM-accessibility
    }                                                                           //IBM-accessibility
    protected void selectPreviousPossibleValue() {                              //IBM-accessibility
        int si = listBox.getSelectedIndex();                                    //IBM-accessibility
        if ( si > 0 ) {                                                         //IBM-accessibility
            listBox.setSelectedIndex( si - 1 );                                 //IBM-accessibility
            listBox.ensureIndexIsVisible( si - 1 );                             //IBM-accessibility
            comboBox.repaint();                                                 //IBM-accessibility
        }                                                                       //IBM-accessibility
    ...
    public void configureEditor() {
        ...
        if (editorActionListener == null) {                                     //IBM-accessibility
            editorActionListener = new ActionListener() {                       //IBM-accessibility
                    public void actionPerformed(ActionEvent e) {                //IBM-accessibility
                        if (isPopupVisible(comboBox)) {                         //IBM-accessibility
                            comboBox.setSelectedIndex(                          //IBM-accessibility
                                    listBox.getSelectedIndex());                //IBM-accessibility
                        }                                                       //IBM-accessibility
                    }                                                           //IBM-accessibility
                };                                                              //IBM-accessibility
            comboBox.getEditor().addActionListener(                             //IBM-accessibility
                                         editorActionListener);                 //IBM-accessibility
        }                                                                       //IBM-accessibility
    }
    ...
    public void unconfigureEditor() {
        ...
        if (editorActionListener != null) {                                     //IBM-accessibility
            (comboBox.getEditor()).removeActionListener(                        //IBM-accessibility
                                          editorActionListener);                //IBM-accessibility
            editorActionListener = null;                                        //IBM-accessibility
        }                                                                       //IBM-accessibility
    }
