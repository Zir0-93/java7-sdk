...
//        String language = Locale.getDefault().getLanguage();                  //IBM-swing_bringup
//        String desktop =                                                      //IBM-swing_bringup
//            AccessController.doPrivileged(new GetPropertyAction("sun.desktop")); //IBM-swing_bringup

//        boolean isCjkLocale = (Locale.CHINESE.getLanguage().equals(language) || //IBM-swing_bringup
//                Locale.JAPANESE.getLanguage().equals(language) ||             //IBM-swing_bringup
//                Locale.KOREAN.getLanguage().equals(language));                //IBM-swing_bringup
//        boolean isGnome = "gnome".equals(desktop);                            //IBM-swing_bringup
        boolean isLocal = SwingUtilities2.isLocalDisplay();

//        boolean setAA = isLocal && (!isGnome || !isCjkLocale);                //IBM-swing_bringup

        /*** Apply workaround for GNOME CJK NullPointerExecption problem ******/ //IBM-swing_bringup
        /*Object aaTextInfo = SwingUtilities2.AATextInfo.getAATextInfo(setAA);*/ //IBM-swing_bringup
        Object aaTextInfo = SwingUtilities2.AATextInfo.getAATextInfo(isLocal);  //IBM-swing_bringup
        return aaTextInfo;
    }
